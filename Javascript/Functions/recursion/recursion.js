...
function repeatStr2(str1,str2)
{
    ...
    return str1 +' '+ repeatSrt2(str1 , str2.slice(0,str2.length - 1));
}
...
function numberBetweenUs(num1 , num2)
{
    ...
    return num1 + ","  + numberBetweenUs(num1+1 , num2);
}
/*
10
...
function countDown(number)
{
    ...
    return number + ","+countDown(number-1); // + countDown(--number)
...
function mirror (str)
{
    ...
    return str[str.length - 1] + mirror(str.slice(0,str.length-1));
}
...
function mirrorCaseAlso(str)
{
    ...
    var char = (lastChar === lastChar.toLowerCase())?lastChar.toUpperCase():lastChar;
    if(str.length ===1)
    {
        return char;
    }
...
function repeatChar(str,char)
{
    ...
    if(char.toLowerCase() === str[str.length-1].toLowerCase())
    {
        count++; 
    }
    ...
    return count + repeatChar(str.slice(0,str.length - 1),char);
}
